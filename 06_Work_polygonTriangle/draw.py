...
def draw_polygons( polygons, screen, color ):
    ...
    view = [0, 0, 1]
    while counter < max:
        normal = calculate_normal(polygons, counter)
        c = dot_product(view, normal)
        if c > 0:
            v0 = polygons[counter]
            v1 = polygons[counter + 1]
            v2 = polygons[counter + 2]
            #print(v0)
            #print("+++++++")
    ...
    for lat in range(lat_start, lat_stop):
        for longt in range(longt_start, longt_stop):
            ...
            if lat == step - 2:
                ...
                if longt != 0:
                    v2 = points[index + step]
                else:
                    v2 = points[index + step + 1]

            add_polygon(polygons, v0[0],
                     v0[1],
                     v0[2],
                     v1[0],
                     v1[1],
